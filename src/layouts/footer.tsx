  ...
  return (
    <>
      <style>{`
            ...
            `}</style>
      <footer className="atmos-footer bg-[#0d2346] dark:bg-[#040810] py-12 px-4 sm:px-6 lg:px-8 tracking-[0.015em] border-t dark:border-white/10 transition-colors duration-300">
