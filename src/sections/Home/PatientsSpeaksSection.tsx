...
export const PatientsSpeaksSection: React.FC = () => {
  ...
  return (
    <section className="relative py-20 lg:py-28 bg-white dark:bg-transparent overflow-hidden tracking-[0.015em] border-t border-[#dce8ee] dark:border-white/10 transition-colors duration-300">
      <style>{`
