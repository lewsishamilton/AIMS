...
const DEPARTMENTS = [
  { name: "Pre-Clinical", image: preclinicalImg, imageAlt: "Pre-Clinical Department" },
  { name: "Para-Clinical", image: paraclinicalImg, imageAlt: "Para-Clinical Department" },
  { name: "Clinical", image: clinicalImg, imageAlt: "Clinical Department" },
];

const DepartmentsSection = () => {
  return (
    <section className="relative pb-20 lg:pb-28 pt-8 lg:pt-12 bg-white overflow-hidden">
      <div className="relative z-10 w-full max-w-[1340px] mx-auto px-4 sm:px-14 lg:px-20">
        <div className="text-center mb-12">
          <h2 className="font-['Manrope',sans-serif] text-3xl sm:text-4xl lg:text-[44px] font-extrabold leading-[1.15] tracking-tight text-[#1f3351]">
            Our Departments
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {DEPARTMENTS.map((dept) => (
            ...
            >
              ...
              <h3 className="absolute bottom-5 inset-x-0 text-center font-['Manrope',sans-serif] text-2xl font-extrabold text-white">
                {dept.name}
              </h3>
            </div>
          ))}
