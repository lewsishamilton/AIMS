      ...
      <div className="w-full max-w-[1240px] mx-auto px-4 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          >
            ...
            {/* Content */}
            <ul className="space-y-3 text-base text-[#62748a] dark:text-slate-300 leading-relaxed">
              <li className="flex items-start gap-2.5">
                <span className="text-[#1f3351] dark:text-teal-400 font-bold mt-1 text-sm">•</span>
                <span>
