...
export const DISCOVER_PAGES: Record<string, StaticPageDef> = {
  "/about/awards": {
    eyebrow: "The AIMS Story",
    title: "Awards & Achievements",
    subtitle:
      "Recognition earned by Arundathi Institute of Medical Sciences and Marri Arundhathi Multi-Specialty Hospital — in accreditation, in clinical capability, and in the everyday work of treating a community.",
    sections: [
      {
        title: "Institutional Recognition",
        content:
          "The strongest recognition a teaching hospital can hold is the approval of the bodies that inspect it. AIMS holds NABH accreditation for the hospital, National Medical Commission recognition for the MBBS programme, and academic affiliation to Kaloji Narayana Rao University of Health Sciences, Warangal.",
        badges: ["NABH Accredited", "NMC Recognised", "KNRUHS Affiliated"],
        layout: "full",
      },
      {
        title: "NABH Accreditation",
        content:
          "Accreditation by the National Accreditation Board for Hospitals & Healthcare Providers, reflecting audited standards in quality of care, patient safety, clinical protocols and continuous improvement.",
        layout: "half",
      },
      {
        title: "NMC Recognition",
        content:
          "Recognition of the undergraduate medical programme by the National Medical Commission, confirming compliance with national standards for faculty, infrastructure, laboratories and clinical training.",
        layout: "half",
      },
      {
        title: "Clinical Milestones",
        bullets: [
          "Commissioning of a Philips cardiac catheterisation laboratory for diagnostic and interventional cardiology",
          "Installation of a Siemens Sempra 1.5 Tesla MRI and a 50-slice CT scanner",
          "Establishment of super-speciality services in cardiology, CTVS, neurology, neurosurgery, nephrology, urology and gastroenterology",
          "A licensed blood bank with component separation, supporting trauma, surgical and obstetric services",
          "24×7 casualty, diagnostics and critical care since the hospital opened",
        ],
        layout: "full",
      },
      {
        ...
        bullets: [
          "Annual MBBS intake of 150 students under NMC permission",
          "Departmental research projects submitted for external funding",
          "A Central Research Laboratory shared across pre-clinical, para-clinical and clinical departments",
          "A Medical Education Unit driving competency-based curriculum delivery and faculty training",
        ],
        layout: "half",
      },
      {
        ...
        bullets: [
          "Rural and urban health outreach through the Department of Community Medicine",
          "Screening camps, health-awareness drives and voluntary blood-donation camps",
          "Complimentary food and mineral water for every admitted patient",
          "Affordable care as the founding principle of the institution",
        ],
        layout: "half",
      },
    ],
